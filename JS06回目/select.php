...
if($status==false){
  ...
  while($result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<a class="float_right" href="posts.php?post_id='.$result["post_id"].'"><i class="far fa-heart heart"> '.$result["heart_num"].'</i><i class="far fa-comment comment"> '.$result["comment_num"].'</i></a><br><br>';
