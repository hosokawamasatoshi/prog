...
<div id="act_input">
  <form method="POST" action="reply_posts.php" name="reply_form">
    <div id="container">
      <textarea id="posts" rows="10" name="r_comment" placeholder="<?=$result["u_name"]?>さんへのコメント"></textarea>
      <div class="act_btn_wrap"><input id="activity_btn" type="submit" value="送信" onclick="form_reset()"></div>
      <input type="hidden" name="r_post_id" value="<?=$r_post_id?>">
    </div>
  </form>
</div>
</body>
